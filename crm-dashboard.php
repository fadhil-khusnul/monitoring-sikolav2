                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div dir="ltr">
                                            <div id="sales-analytics" class="apex-charts" data-colors="#077AC3,#1abc9c"></div>
                                        </div>
                                    </div>
                                </div> <!-- end card -->
                            </div> <!-- end col-->
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-start mt-3">
                                            <img class="me-3 rounded-circle" src="assets/images/users/user-3.jpg" width="40" alt="Generic placeholder image">
                                            <div class="w-100">
                                        ...
                                        <div class="d-flex align-items-start mt-3">
                                            <img class="me-3 rounded-circle" src="assets/images/users/user-4.jpg" width="40" alt="Generic placeholder image">
                                            <div class="w-100">
                                        ...
                                        <div class="d-flex align-items-start mt-3">
                                            <img class="me-3 rounded-circle" src="assets/images/users/user-5.jpg" width="40" alt="Generic placeholder image">
                                            <div class="w-100">
                                                <span class="badge badge-soft-warning float-end">Cold lead</span>
                                        ...
                                        <div class="d-flex align-items-start mt-3">
                                            <img class="me-3 rounded-circle" src="assets/images/users/user-6.jpg" width="40" alt="Generic placeholder image">
                                            <div class="w-100">
                                                <span class="badge badge-soft-success float-end">Won lead</span>

...
function nameFormatter(e, t) {
  ...
  t.id; return '<span class="text-muted"> ' + e + "</span>"
}
function statusFormatter(e, t) {
  var n; "Paid" == e ? n = "success" : "Unpaid" == e ? n = "warning" : "Shipped" == e ? n = "info" : "Refunded" == e && (n = "danger"); t.id;
...
$(document).ready(function () {
  var t = $("#demo-custom-toolbar"), n = $("#demo-delete-row");

  t.on("check.bs.table uncheck.bs.table check-all.bs.table uncheck-all.bs.table", function () { n.prop("disabled", !t.bootstrapTable("getSelections").length) }), n.click(function () {
    var e = $.map(t.bootstrapTable("getSelections"), function (e) {

      return e.id
    });
    t.bootstrapTable("remove", { field: "id", values: e }), n.prop("disabled", !0)
  })

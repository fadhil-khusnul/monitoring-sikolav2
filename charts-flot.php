                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="website-stats" style="height: 350px;" class="flot-chart mt-5" data-colors="#4fc6e1,#077AC3"></div> 
                                    </div>
                                </div> <!-- end card -->
                            </div> <!-- end col -->
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="website-stats1" style="height: 350px;" class="flot-chart mt-5" data-colors="#077AC3,#f1556c"></div>    
                                    </div>
                                </div>
                            </div> <!-- end col -->
                        </div>
